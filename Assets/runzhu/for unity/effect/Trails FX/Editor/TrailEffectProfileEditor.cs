...
namespace TrailsFX {
    ...
    public class TrailEffectProfileEditor : Editor {
        ...
        SerializedProperty renderOrder, clearStencil, hierarchyOccluder, hierarchyOccluderRoot, hierarchyOccluderLayerMask, hierarchyIncludeInactive, cullMode, subMeshMask, lookTarget, lookToCamera, ground;
        ...
        public override void OnInspectorGUI () {
            ...
            if ((TrailRenderOrder)renderOrder.enumValueIndex == TrailRenderOrder.DrawBehind) {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(hierarchyOccluder, new GUIContent("Hierarchy Occluder"));
                if (hierarchyOccluder.boolValue) {
                    EditorGUILayout.PropertyField(hierarchyOccluderRoot, new GUIContent("Occluder Root"));
            ...
            TrailEffect[] effects = FindObjectsByType<TrailEffect>(FindObjectsSortMode.None);
#else
