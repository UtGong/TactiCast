...
namespace TrailsFX {
	...
	public partial class TrailEffectProfile : ScriptableObject {
		...
		public void Load (TrailEffect effect) {
			...
			effect.hierarchyOccluder = hierarchyOccluder;
			effect.hierarchyOccluderRoot = hierarchyOccluderRoot;
			effect.hierarchyOccluderLayerMask = hierarchyOccluderLayerMask;
			effect.hierarchyIncludeInactive = hierarchyIncludeInactive;
			effect.RefreshHierarchyOccluders();
			effect.mask = mask;
		...
		public void Save (TrailEffect effect) {
			...
			hierarchyOccluder = effect.hierarchyOccluder;
			hierarchyOccluderRoot = effect.hierarchyOccluderRoot;
			hierarchyOccluderLayerMask = effect.hierarchyOccluderLayerMask;
			hierarchyIncludeInactive = effect.hierarchyIncludeInactive;
			mask = effect.mask;
